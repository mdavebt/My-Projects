...
SCC <- readRDS("Source_Classification_Code.rds")
	...
	meltNEI <- melt(NEI_baltimore, id.vars = "year", measure.vars = "Emissions",na.rm=TRUE,value.name="pm25")
	...
	plot(names(dNEI),avg_PM25_TONS,ylab = "Average PM2.5 (tons)",xlab = "Year", main = "Average Emission of PM25 for Baltimore City")
